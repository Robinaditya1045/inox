  ...
  return (
    <div
      style={{
        ...
        background:
          "radial-gradient(circle at 50% 10%, rgba(170, 59, 255, 0.15) 0%, var(--color-bg-obsidian) 70%)",
        padding: "24px",
      }}
    >
      <div
        ...
        style={{
          ...
          gap: "24px",
          boxShadow:
            "0 0 40px rgba(0, 0, 0, 0.8), 0 0 20px rgba(170, 59, 255, 0.15)",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <div
          style={{
            ...
            height: "2px",
            background:
              "linear-gradient(90deg, transparent, var(--color-accent-purple), transparent)",
          }}
        />
